...
// configuration step. It creates a namespace called `best_practices_test`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", best_practices_test::cmake::project_name, best_practices_test::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", best_practices_test::cmake::project_version);
      return EXIT_SUCCESS;
    }
